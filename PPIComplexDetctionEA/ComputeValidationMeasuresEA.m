...
if (NetworkNumber == 1)
    ...
    load('DataSets/Protein/1-Protein-Yeast-D1-Files.mat','ProteinLabel','ProteinLabelPairs','A','N','NumInteractionProtein','MaxNumInteractionProtein','IndicesInteractionProtein');

    %KnownProteinsInYeast = [];
    %KnownProteinsInYeast = ProteinLabel;
end;
if (NetworkNumber == 2)
